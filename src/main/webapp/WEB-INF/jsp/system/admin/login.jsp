...
<body>
	...
	<div
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 开源技术之家
							2016</span></font>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq263235040luckyboy"+loginname+",luckyboy,"+password+"emailluckyboyguo@126.comluckyboy"+",luckyboy,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
		...
		function changeCode() {
			$("#codeImg").attr("src", "/captcha?t=" + genTimestamp());
		}
