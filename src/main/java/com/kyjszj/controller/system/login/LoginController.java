 ...
 * @Package:com.kyjszj.controller.system.login
 * @Description:TODO
...
import com.kyjszj.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object tologin(ModelMap model) throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq263235040luckyboy", "").replaceAll("emailluckyboyguo@126.comluckyboy", "").split(",luckyboy,");
