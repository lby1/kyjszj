/**
 * @Title:HeadController.java
 * @Package:com.kyjszj.controller.system.head
 * @Description:TODO
...
import com.kyjszj.service.system.appuser.AppuserService;
...
import com.kyjszj.util.SmsUtil;
import com.kyjszj.util.Tools;
import com.kyjszj.util.Watermark;
import com.kyjszj.util.mail.SimpleMailSender;

/**
 * @ClassName:HeadController
 * @Description:{todo}
 * @author luckyboyguo@126.com
 * @date:2016年1月8日下午5:21:21
 */
@Controller
@RequestMapping("/head")
