...
public class Watermark {
		...
		*/
	  	public static void setWatemark(HttpServletRequest request,String imagePath){ 
	  		//文字水印
	  		if(null != strFWATERM && !"".equals(strFWATERM)){
				String strFW[] = strFWATERM.split(",kyjszj,");
				if(strFW.length == 5){
			...
			if(null != strIWATERM && !"".equals(strIWATERM)){
				String strIW[] = strIWATERM.split(",kyjszj,");
				if(strIW.length == 4){
					if("yes".equals(strIW[0])){
						pressImage(request.getSession().getServletContext().getRealPath("/")+ Const.FILEPATHIMG+strIW[1], imagePath, Integer.parseInt(strIW[2]), Integer.parseInt(strIW[3]));
					}
				}
			}
		  } 
	    ...
	    public final static void pressImage(String pressImg, String targetImg,
	        ...
	        try {
	            ...
	            System.out.println(_filebiao.getPath());
